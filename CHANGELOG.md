...
- Export the Node.js 22.13+ dependency-free ESM library and a five-command CLI.
...
- Ship the audited active skill catalog, contracts, coverage documentation and
  generated portable packs under the MIT license.
