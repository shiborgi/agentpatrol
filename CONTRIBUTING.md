...
Use Node.js 22.13+ and npm. There are no third-party runtime dependencies. Read
...
Keep the shared skill tree aligned with the validated active catalog. Normalize and
validate a skill contract before adding it to an active descriptor.
